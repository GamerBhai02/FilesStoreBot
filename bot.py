    ...
    if usr_cmd == "/start":
        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("😇 Join Channel 😇", url="https://t.me/+QgSl55NlTiI0NDhl")
                    ],
                    [
                    ...
                    [
                        InlineKeyboardButton("Movies Channel", url="https://t.me/+QgSl55NlTiI0NDhl"),
                        InlineKeyboardButton("Movies Group", url="https://t.me/+ZUyhAwBNBsU0YjA9")
                    ]
                ]
            )
        )
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my [Owner](https://t.me/GamerBhai02).",
                        disable_web_page_preview=True
                    )
                    return
                ...
                await cmd.message.edit(
                    text="Something went Wrong. Contact my [Owner](https://t.me/GamerBhai02).",
                    disable_web_page_preview=True
                )
                return
        await cmd.message.edit(
